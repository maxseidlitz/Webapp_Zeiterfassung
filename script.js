...
function stopTimer() {
    timerInterval = new Date() - startTime;
    hours = timerInterval / (1000 * 3600);
    seconds = timerInterval / (1000);
    milliseconds = timerInterval;

    console.log("Hours: " + hours + " Seconds: " + seconds + " Milliseconds: " + milliseconds);
}
